...
return [
    ...
    'index_route_description' => 'Retrieve existing ships.',
    'index_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_key_is_the_model_property_and_the_value_is_the_model_value' => 'The array\'s key is the ships property name where the value is the assigned value to the retrieved ships.',
    ...
    'show_route_description' => 'Retrieve existsing ships.',
    'show_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_id_of_model_to_retrieve' => 'The unique id of the ships to retrieve',
    'destroy_route_description' => 'Delete existsing ships.',
    ...
    'the_id_of_model_to_delete' => 'The id of the ships to delete.',
    'general_description' => 'Allows you to list, create, edit, show and delete ships.',
    'indicate_whether_the_request_was_successful_or_not' => 'Indicate whether the request was successful or not.',
    'the_id_of_the_model' => 'The id of the ships.',
    ...
    'the_requested_model_does_not_exists' => 'The requested ships does not exists.',
    ...
    'create' => 'Create New Ships',
    'delete' => 'Delete Ships',
    'edit' => 'Edit Ships',
    'show' => 'Show Ships',
    'show_all' => 'Show All Ships',
    'add' => 'Add',
    'update' => 'Update',
    'confirm_delete' => 'Click Ok to delete Ships.',
    'none_available' => 'No Ships Available.',
    'model_plural' => 'Ships',
    'model_was_added' => 'Ships was successfully added.',
    'model_was_retrieved' => 'Ships was successfully retrieved.',
    'models_were_retrieved' => 'Ships were successfully retrieved.',
    'model_was_updated' => 'Ships was successfully updated.',
    'model_was_deleted' => 'Ships was successfully deleted.',
