...
return [
    ...
    'emp_id' => 'Emp',
    'emp_id__placeholder' => 'Select emp',
    'serialNo' => 'الرقم المتسلسل',
    'serialNo__placeholder' => 'Enter serial no here...',
    'date' => 'تاريخ الدخول',
    'date__placeholder' => 'Enter date here...',
    'expiryDuration' => 'مدة الصلاحية',
    'expiryDuration__placeholder' => 'Enter expiry duration here...',
    'exitDate' => 'تاريخ الصلاحية',
    'exitDate__placeholder' => 'Enter exit date here...',
    'file_name' => 'File Name',
    'file_name__placeholder' => 'Enter file name here...',
    'file_path' => 'File Path',
    'file_path__placeholder' => 'Enter file path here...',
    ...
    'index_route_description' => 'Retrieve existing intarnal files.',
    'index_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_key_is_the_model_property_and_the_value_is_the_model_value' => 'The array\'s key is the intarnal files property name where the value is the assigned value to the retrieved intarnal files.',
    ...
    'the_index_of_the_first_retrieved_item' => 'The index of first retrieved intarnal files.',
    'the_number_of_the_last_page' => 'The number of the last page.',
    'the_base_link_to_the_resource' => 'The base link to the api resource.',
    'the_number_of_models_per_page' => 'The number of intarnal files per page.',
    'the_index_of_the_last_retrieved_item' => 'The index of last retrieved intarnal files.',
    'the_total_of_available_pages' => 'The total of the available pages.',
    'store_route_description' => 'Create new intarnal files.',
    'store_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'update_route_description' => 'Update existsing intarnal files.',
    ...
    'show_route_description' => 'Retrieve existsing intarnal files.',
    'show_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_id_of_model_to_retrieve' => 'The unique id of the intarnal files to retrieve',
    'destroy_route_description' => 'Delete existsing intarnal files.',
    ...
    'the_id_of_model_to_delete' => 'The id of the intarnal files to delete.',
    'general_description' => 'Allows you to list, create, edit, show and delete intarnal files.',
    'indicate_whether_the_request_was_successful_or_not' => 'Indicate whether the request was successful or not.',
    'the_id_of_the_model' => 'The id of the intarnal files.',
    ...
    'the_requested_model_does_not_exists' => 'The requested intarnal files does not exists.',
    ...
    'create' => 'Create New Intarnal Files',
    'delete' => 'Delete Intarnal Files',
    'edit' => 'Edit Intarnal Files',
    'show' => 'Show Intarnal Files',
    'show_all' => 'Show All Intarnal Files',
    'add' => 'Add',
    'update' => 'Update',
    'confirm_delete' => 'Click Ok to delete Intarnal Files.',
    'none_available' => 'No Intarnal Files Available.',
    'model_plural' => 'Intarnal Files',
    'model_was_added' => 'Intarnal Files was successfully added.',
    'model_was_retrieved' => 'Intarnal Files was successfully retrieved.',
    'models_were_retrieved' => 'Intarnal Files were successfully retrieved.',
    'model_was_updated' => 'Intarnal Files was successfully updated.',
    'model_was_deleted' => 'Intarnal Files was successfully deleted.',
    ...
    'model_id_camel_case' => 'intarnal filesId',
