				...
				<div class="row">
					...
					<div class="col-xl-12">
						<div class="card mg-b-20">
							...
							<div class="card-body">
							<div>
								<h3 class="text-center"> عربات بالداخل ومتبقي المدة لها اقل من  15 يوم</h3>
	                      <br/>
							</div>
						 ...
						 <div class="table-responsive">
                           ...
                           <td>{{ optional($emportcars->Customer->Car)->chassisNo }}</td>
							...
							<td>{{ $emportcars->exitDate }}</td>
									...
									<td>
									<a class="btn btn-info" data-effect="effect-scale"   title="السيارة غادرت"
...
$('#modaldemo6').on('show.bs.modal', function(event) {
	        ...
	        var modal = $(this)
				...
				$(".body1 #exitDate").val($(event.relatedTarget).attr('data-exitDate'));
	});
</script>
<script>
