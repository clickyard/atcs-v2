...
@section('page-header')
				...
				<div class="breadcrumb-header justify-content-between">
					<div class="my-auto">
						<div class="d-flex">
							<h4 class="content-title mb-0 my-auto"> الإعدادات</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ قائمة السيارات المتخلفة عن المغادرة</span>
						</div>
					</div>
				...
				<div class="row">
					...
					<div class="col-xl-12">
						<div class="card mg-b-20">
							...
							<div class="card-body">
							<div>
									<h3 class="text-center">  عربات متخلفة عن المغادرة
								</div>
                            @if(count($tarheel) == 0)
