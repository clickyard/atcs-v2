 ...
 <div class="col-md-5 col-lg-4  form-group {{ $errors->has('carnetNo') ? 'has-error' : '' }}">
            ...
            <div class="">
                <input class="form-control" name="carnetNo" type="text" id="carnetNo" value="{{ old('carnetNo', optional($emportcars)->carnetNo) }}" minlength="1" required="true" placeholder="{{ trans('emportcars.carnetNo__placeholder') }}">
        ...
        <div class="col-md-5 col-lg-4  form-group {{ $errors->has('car_id') ? 'has-error' : '' }}">
            ...
            <div class="">
            <input class="form-control" name="car_id" type="text" id="" value="{{ optional($emportcars->Customer->car->Vehicle)->name }}" readonly>
        ...
        <div class="col-md-5 col-lg-4  form-group {{ $errors->has('cus_id') ? 'has-error' : '' }}">
            ...
            <div class="">
            <input name="cus_id" type="hidden" value="{{ optional($emportcars)->cus_id }}">
        ...
        <div class="col-md-5 col-lg-4  form-group {{ $errors->has('destination') ? 'has-error' : '' }}">
            ...
            <div class="">
                <input class="form-control" name="destination" type="text" id="destination" value="{{ old('destination', optional($emportcars)->destination) }}" minlength="1" maxlength="100" required="true" placeholder="{{ trans('emportcars.destination__placeholder') }}">
        ...
        <div class="col-md-5 col-lg-4  form-group {{ $errors->has('shippingAgent') ? 'has-error' : '' }}">
            ...
            <div class="">
                <input class="form-control" name="shippingAgent" type="text" id="shippingAgent" value="{{ old('shippingAgent', optional($emportcars)->shippingAgent) }}" min="1" max="100" required="true" placeholder="{{ trans('emportcars.shippingAgent__placeholder') }}">
        ...
        <div class="col-md-5 col-lg-4  form-group {{ $errors->has('deliveryPerNo') ? 'has-error' : '' }}">
            ...
            <div class="">
                <input class="form-control" name="deliveryPerNo" type="text" id="deliveryPerNo" value="{{ old('deliveryPerNo', optional($emportcars)->deliveryPerNo) }}" minlength="1" required="true" placeholder="{{ trans('emportcars.deliveryPerNo__placeholder') }}">
        ...
        <div class="col-md-5 col-lg-4  form-group {{ $errors->has('issueDate') ? 'has-error' : '' }}">
            ...
            <div class="">
                <input class="form-control" name="issueDate" type="date" id="issueDate" value="{{ old('issueDate', optional($emportcars)->issueDate) }}" required="true" placeholder="{{ trans('emportcars.issueDate__placeholder') }}">
        ...
        <div class="col-md-5 col-lg-4  form-group {{ $errors->has('expiryDate') ? 'has-error' : '' }}">
            ...
            <div class="">
                <input class="form-control" name="expiryDate" type="date" id="expiryDate" value="{{ old('expiryDate', optional($emportcars)->expiryDate) }}" required="true" placeholder="{{ trans('emportcars.expiryDate__placeholder') }}">
        ...
        <div class="col-md-5 col-lg-4  form-group {{ $errors->has('entryDate') ? 'has-error' : '' }}">
            ...
            <div class="">
                <input class="form-control" name="entryDate" type="date" id="entryDate" value="{{ old('entryDate', optional($emportcars)->entryDate) }}" required="true" placeholder="{{ trans('emportcars.entryDate__placeholder') }}">
        ...
        <div class="col-md-5 col-lg-4  form-group {{ $errors->has('exitDate') ? 'has-error' : '' }}">
            ...
            <div class="">
                <input class="form-control" name="exitDate" type="date" id="exitDate" value="{{ old('exitDate', optional($emportcars)->exitDate) }}" required="true" placeholder="{{ trans('emportcars.exitDate__placeholder') }}">
