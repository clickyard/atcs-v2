...
@section('page-header')
				...
				<div class="breadcrumb-header justify-content-between">
					<div class="my-auto">
						<div class="d-flex">
							<h4 class="content-title mb-0 my-auto"> الإعدادات</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ قائمة السيارات التي تم ترحيلها</span>
						</div>
					</div>
				...
				<div class="row">
					...
					<div class="col-xl-12">
						...
						<h3 class="card-title mg-b-0">التاريخ: {{date('d-m-Y')}}</h3>
							...
							<div>
								<h3 class="text-center" style=" text-decoration: underline; text-decoration-skip-ink: none "> تقرير بقائمة السيارات التي تم ترحيلها</h3>
	                      <br/>
							</div>
                            @if(count($tarheel) == 0)
