...
@section('content')
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-heading clearfix">
            ...
            <div class="pull-left">
                <h4 class="mt-5 mb-5">{{ trans('guarefrances.model_plural') }}</h4>
            </div>
        ...
        @if(count($guarefrancesObjects) == 0)
            <div class="panel-body text-center">
                <h4>{{ trans('guarefrances.none_available') }}</h4>
            </div>
        @else
        <div class="panel-body panel-body-with-table">
            <div class="table-responsive">
                ...
                <table class="table table-striped ">
                    ...
                    <tbody>
                    @foreach($guarefrancesObjects as $guarefrances)
                        <tr>
                            ...
                            <td>
                                ...
                                {{ csrf_field() }}
                                    ...
                                    <div class="btn-group btn-group-xs pull-right" role="group">
                                        <a href="{{ route('guarefrances.guarefrances.show', $guarefrances->id ) }}" class="btn btn-info" title="{{ trans('guarefrances.show') }}">
