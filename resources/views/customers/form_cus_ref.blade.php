...
<div class="row row-sm col-md-9 col-lg-12">
        ...
        <div class="col-md-5 col-lg-4  form-group   {{ $errors->has('ccity') ? 'has-error' : '' }}">
            ...
            <div class="">
                <input class="form-control" name="addMore[{{ $i }}][ccity]" type="text" id="ccity" value="{{ old('ccity', optional($customers)->ccity) }}" minlength="1" maxlength="900" required="true" placeholder="{{ trans('custrefrances.ccity__placeholder') }}">
        ...
        <div class="col-md-5 col-lg-4  form-group   {{ $errors->has('ctel') ? 'has-error' : '' }}">
            ...
            <div class="">
                <input class="form-control text-left " name="addMore[{{ $i }}][ctel]" type="tel" id="ctel{{$i}}" value="{{ old('ctel', optional($customers)->ctel) }}" minlength="1" required="true" placeholder="{{ trans('custrefrances.ctel__placeholder') }}">
